  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-4 gap-4 pt-5" style={{ borderTop: '1px solid #2B3139' }}>
        <div className="p-3 rounded transition-all hover:bg-opacity-50" style={{ background: 'rgba(52, 211, 153, 0.05)' }}>
        ...
        <div className="p-3 rounded transition-all hover:bg-opacity-50" style={{ background: 'rgba(52, 211, 153, 0.05)' }}>
          ...
          <div className="text-base font-bold mono" style={{ color: currentGap > 1 ? '#34d399' : '#EAECEF' }}>
